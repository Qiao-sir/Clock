...
#define EXAMPLE_PIN_NUM_I2C_SDA    41  // 您的 SDA 引脚
#define EXAMPLE_PIN_NUM_I2C_SCL    42  // 您的 SCL 引脚
#define EXAMPLE_PIN_NUM_TOUCH_RST  11  // 如果有复位引脚，指定相应引脚编号，否则为 -1
#define EXAMPLE_PIN_NUM_TOUCH_INT  12  // 如果有中断引脚，指定相应引脚编号，否则为 -1
#define I2C_BUS_PORT  0
#define EXAMPLE_I2C_FREQ_HZ  100000  // 100kHz
...
void app_main(void)
{
    ...
    //     .dev_addr = 0x37, //EXAMPLE_I2C_HW_ADDR,
    ...
    esp_lcd_panel_io_i2c_config_t tp_io_config = ESP_LCD_TOUCH_IO_I2C_FT5x06_CONFIG(); //ESP_LCD_TOUCH_IO_SPI_STMPE610_CONFIG(EXAMPLE_PIN_NUM_TOUCH_CS);
    // Attach the TOUCH to the SPI bus
    ESP_ERROR_CHECK(esp_lcd_new_panel_io_i2c(i2c_bus, &tp_io_config, &tp_io_handle));
    ESP_LOGI(TAG, "FT5x06 touch controller initialized successfully");
